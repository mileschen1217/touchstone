...
> **ADOPTED 2026-07-11** — 併入 conductor epic `orchestration-mode-v2`
> 作為 SDD-on-L2 story（miles 裁：同一 epic 的兩面，單一 tracker 在
> conductor 側）。touchstone 側可見性 stub：
> `.touchstone/epics/sdd-on-l2-contracts/index.md`。本文件保留為輸入原文。
