# Fixture: bypass-unknown-arg — AC-7 (Baseline always-on: Foundation-elicitation phase reached on unrecognized arg)
# Harness contract: skills/<skill>/tests/step0-fixtures/ two-layer schema
# Spec authority: intention-first epic § AC-7
#
# "report-export" is parsed as feature_name (not a flag); must NOT skip the Foundation-elicitation phase.
