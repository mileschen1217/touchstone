# Fixture: bypass-quick — AC-7 (Baseline always-on: Foundation-elicitation phase reached on "quick" arg)
# Harness contract: skills/<skill>/tests/step0-fixtures/ two-layer schema
# Spec authority: intention-first epic § AC-7
#
# "quick" is a real modifier that skips the architect critique,
# but must NOT also skip the Foundation-elicitation phase. This fixture proves it is REACHED.
