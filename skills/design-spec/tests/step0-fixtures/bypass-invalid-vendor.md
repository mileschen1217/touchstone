...
# It does NOT assert the Foundation-elicitation phase runs — it is intentionally not reached on
...
# Does NOT assert the Foundation-elicitation phase runs.
required-phrases:
  # the EXACT loud-error text from design-spec/SKILL.md § Usage —
