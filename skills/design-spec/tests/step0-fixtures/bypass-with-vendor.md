# Fixture: bypass-with-vendor — AC-7 (Baseline always-on: Foundation-elicitation phase reached on "with codex" arg)
# Harness contract: skills/<skill>/tests/step0-fixtures/ two-layer schema
# Spec authority: intention-first epic § AC-7
#
# "with codex" routes the architect; must NOT skip the Foundation-elicitation phase.
