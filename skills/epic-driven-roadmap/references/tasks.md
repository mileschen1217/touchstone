...
2. Resolve concrete path from project CLAUDE.md § Doc Routing. Default `.touchstone/epics/<slug>/tasks/<task-id>/`; use a different home only when the project's Doc Routing names one.
