# demo skill (red) — six same-shape items, no stated generating rule
...
- **Delta rule** — do the fourth thing when delta happens.
- **Epsilon rule** — do the fifth thing when epsilon happens.
- **Zeta rule** — do the sixth thing when zeta happens.
